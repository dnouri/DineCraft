...
describe('World', () => {
    ...
    describe('getBlock', () => {
        ...
        it('should return the generated block from the upper chunk (Y=0)', () => {
            // Test coordinate (8, 0, 8) with seed 67890 generates Stone
            expect(world.getBlock(8, 0, 8)).toBe(BLOCKS[3].id); // Expect Stone (Generated by noise)
        });

        it('should return the generated block from the lower chunk (Y=-1)', () => {
            // Test coordinate (8, -1, 8) with seed 67890 generates Stone
            expect(world.getBlock(8, -1, 8)).toBe(BLOCKS[3].id); // Expect Stone (Generated by noise)
        });
        ...
        it('should return the generated block for the top layer of the upper chunk (Y=255)', () => {
            // Test coordinate (8, 255, 8) with seed 67890 generates Stone
            expect(world.getBlock(8, 255, 8)).toBe(BLOCKS[3].id); // Expect Stone (Generated by noise)
        });
    ...
    describe('setBlock', () => {
        ...
        it('should set a block in the lower chunk (Y=-1) and mark it dirty', () => {
            // Test coordinate (5, -1, 5) with seed 67890 generates Stone initially
            expect(world.getBlock(5, -1, 5)).toBe(BLOCKS[3].id); // Expect Stone (Generated by noise)
        ...
        it('should set a block in the upper chunk (Y=0) and mark it dirty', () => {
            // Test coordinate (5, 0, 5) with seed 67890 generates Stone initially
            expect(world.getBlock(5, 0, 5)).toBe(BLOCKS[3].id); // Expect Stone (Generated by noise)
